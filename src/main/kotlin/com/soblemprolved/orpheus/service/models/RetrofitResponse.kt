...
sealed class RetrofitResponse<out T> {
     ...
     */
    data class Success<out T>(val value: T): RetrofitResponse<T>()
     ...
     * discern its meaning.
     */
    data class Failure<T>(val call: Call<T>, val response: Response<T>): RetrofitResponse<T>() {
